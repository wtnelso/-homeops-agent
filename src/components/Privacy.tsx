    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl font-bold text-white mb-8">HomeOps Privacy Policy</h1>
          ...
          <div className="prose prose-lg max-w-none prose-invert">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">1. Personal Information</h3>
              ...
              <h3 className="text-xl font-semibold text-white mb-3">2. Email Data</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">3. Technical Data</h3>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">1. Core Service Delivery</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">2. Service Improvement</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">3. Communication</h3>
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">1. OpenAI Integration</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">2. Google OAuth</h3>
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
              ...
              <p className="text-slate-300 mb-6">
                The use of information received from Workspace APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" className="text-indigo-400 hover:text-indigo-300">Google User Data Policy</a>, including the <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" className="text-indigo-400 hover:text-indigo-300">Limited User requirements</a>. HomeOps does not use Google Workspace APIs to develop, improve, or train generalized AI and/or ML models.
              </p>

              <h3 className="text-xl font-semibold text-white mb-3">3. Supabase (Database)</h3>
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">1. Encryption</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">2. Access Controls</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">3. Data Minimization</h3>
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">1. Data Access</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">2. Data Control</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">3. Data Deletion</h3>
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">1. Active Accounts</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">2. Inactive Accounts</h3>
              <ul className="list-disc list-inside text-slate-300 mb-6 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">3. Analytics Data</h3>
              <ul className="list-disc list-inside text-slate-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <div className="bg-slate-900 p-6 rounded-lg mb-4">
                <p className="text-slate-300 mb-4">For questions about this Privacy Policy or your personal data, contact us:</p>
