...
import { RefreshCw, AlertCircle, Sparkles, X, CheckCircle, XCircle, Users, User, Heart, Brain, ChevronLeft, ChevronRight, Cake, GraduationCap, Phone, Calendar, Mail, CalendarDays, Type, FileText, Clock, Tag, Bot, ChevronDown } from 'lucide-react';
...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  const {
    ...
    isStreaming: streamingInProgress,
  ...
  const loadSuggestionsCount = async () => {
    if (!userData?.user?.id) {
      console.log('🔍 No user ID available for loading suggestions count');
      return;
    }
